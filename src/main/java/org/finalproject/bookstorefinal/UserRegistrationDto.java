...
// this dto annotated using hibernate-validation annotations which validate
//trivial fields on empty and our own custom @FieldMatch annotations which validates
// if the password is equal to the confirm password and the email address field is equal
// to the confirm email address field.
